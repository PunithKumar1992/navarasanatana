            ...
            <div class="col-md-12" id="bannerbanner">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form method="post" action="saveadminbanner.html" enctype="multipart/form-data" modelAttribute="adminbanner">
                                <div class="col-md-3">
                                <label> ಬ್ಯಾನರ್  ಚಿತ್ರ ಅಪ್ಲೋಡ್   ಮಾಡಿ
                                </label>
								</div>
                                <div class="col-md-3">
                                   
                                    <input type="file" id="fileUpload" onchange="Upload();" value="" accept=".jpg,.png,jpeg,gif" name="adminbannerfile">
                                </div>
                                <div class="col-md-3">
    ...
    <div class="panel-heading">
     ...
     <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <c:url var="bannerdelete" value="adminbannerdel.html">
        <c:param name="banner_id" value="${bannerlist.banner_id}"></c:param>
        <c:param name="banner_name" value="${bannerlist.banner_name}"></c:param>
        
        </c:url>
    
	 <tr>
            <td>
			<a class="example-image-link" href="images/banner/${bannerlist.banner_name}" data-lightbox="example-set" >		
	<img src="images/banner/${bannerlist.banner_name}" alt="" width="70%"/>
	</a>
	
			<!-- //gallery -->
			</td>
			<td>
		 <a href="${bannerdelete}"><i class="fa fa-trash" aria-hidden="true" ></i></a>
