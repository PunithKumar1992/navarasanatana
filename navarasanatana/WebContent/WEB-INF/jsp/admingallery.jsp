...
<section class="wrapper">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                ...
                                <form:form method="post" action="saveadmingallery.html" enctype="multipart/form-data" modelAttribute="admingallery">
                                <div class="col-md-3">
                                <label>Upload Image</label>
								</div>
                                <div class="col-md-3">
                                   
                                    <input type="file" id="fileUpload" onchange="Upload();" value="" accept=".jpg,.png,jpeg" name="galleryfile">
                                </div>
                                <div class="col-md-3">
                                    <button type="submit" id="sub" class="btn btn-info" style="margin-top:-2%" disabled>Add</button>
                                </div>
                             </form:form>
                            </div>
                        </div>
	...
	<div class="gallery">
		...
		<div class="gallery-grids">
				...
				<c:forEach var="nnagallery" items="${adgallerylist}">
				<c:url var="deleteadmingal" value="deleteadmingal.html">
				<c:param name="gallery_id" value="${nnagallery.gallery_id}"></c:param>
				<c:param name="gallery_image" value="${nnagallery.gallery_image}"></c:param>
				</c:url>
					<div class="col-sm-4 gallery-grids">
					
					<a href="${deleteadmingal}"><i class="fa fa-trash" aria-hidden="true"></i></a>
						<div class="gallery-grid" style="width:450px;height:300px;">
							<a class="example-image-link" href="images/gallery/${nnagallery.gallery_image}" data-lightbox="example-set" >
								<img src="images/gallery/${nnagallery.gallery_image}" alt="" style="width: 70%;height: 90%;" />
            ...
            reader.onload = function (e) {
                ...
                image.onload = function () {
                    ...
                    if (height <= 2400 && width <= 3600 ) {
                    	...
                    	{
                    	 alert("Height and Width must not exceed 1800px & 620px.");
