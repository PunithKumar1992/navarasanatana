            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                              <form:form method="post" action="saveadminteam.html" modelAttribute="adminteam"  enctype="multipart/form-data">
                        <div class="col-md-3" >
                        
                        <form:input path="member_name" placeholder="ಸದಸ್ಯರ ಹೆಸರು"/>
                        </div>
                        <div class="col-md-3">     
                        <form:input path="member_disg" placeholder="ಸದಸ್ಯರ ವೃತ್ತಿ"/>
                        </div>
                        
                        <div class="col-md-3">
                                   <label>ಭಾವಚಿತ್ರ ಅಪ್ಲೋಡ್ ಮಾಡಿ</label>
                                    <input type="file" id="fileUpload" name="teamfile" placeholder="File input" id="fileUpload" onchange="Upload();" value="" accept=".jpg,.png,jpeg">
                                </div>
                                <div class="col-md-3">
                                    <button type="submit" class="btn btn-info" id="sub" style="margin-top:-2%" disabled>Add</button>
                                </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
     ...
     <table class="table table-striped b-t b-light">
        ...
        <tbody>
    <c:forEach var="teamlist" items="${adminteamlist}">
    <c:url var="addeleteteam" value="addeleteteam.html">
    <c:param name="team_id" value="${teamlist.team_id}"></c:param>
    <c:param name="member_image" value="${teamlist.member_image}"></c:param>
    </c:url>
    
    <c:url var="adminteamedit" value="adminteamedit.html">
    <c:param name="team_id" value="${teamlist.team_id}"></c:param>
    </c:url>
    
	 <tr>
	 <td>${teamlist.member_name}</td>
	 <td>${teamlist.member_disg}</td>	
            <td>
			<a class="example-image-link" href="images/team/${teamlist.member_image}" data-lightbox="example-set" >		
	<img src="images/team/${teamlist.member_image}" alt="" width="70%"/>
	</a>
	
			<!-- //gallery -->
			</td>
			<td>
			<a href="${adminteamedit}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
		 <a href="${addeleteteam}"><i class="fa fa-trash" aria-hidden="true"></i></a>
		  </td>
