	...
	<div class="container">
		<div class="row">
			...
			<div class="about_page_sec col-lg-12">
				...
				<c:forEach var="useradmission" items="${useradmissionlist}">
                                    <center> <img src="images/admission/${useradmission.admission_image}" alt="app frm" style="height: 50%;width: 50%;"><br>
                                    <p><a href="images/admission/${useradmission.admission_image}" download>click here </a>to download the application form</p></center> 
                                    </c:forEach>
				</div>
                            </div>
