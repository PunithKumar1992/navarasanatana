            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                        <form:form method="post" action="saveadmineditfaculty.html" modelAttribute="adeditfaculty"  enctype="multipart/form-data">
                        <form:hidden path="faculty_id"/>
                        <input type="hidden" value="${facultyimgtoedit}" name="facultyimgtoedit">
                        <div class="col-md-3" >
