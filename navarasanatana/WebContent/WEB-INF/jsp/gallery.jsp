		...
		<div class="row">
			<div class="dn_portfolio_wrap">
				<div class="portfolio_wrap_inner" id="portfolio_filter">
					<c:forEach var="usergallist" items="${usergallerylist}" >
			
					<div class="col-md-4">
						<div class="port_thumb">
                                                    <img src="images/gallery/${usergallist.gallery_image}" alt="" class="img-responsive">
							<div class="dj_overlay">
								<a href="#gallery_${usergallist.gallery_id}" class="link_icon gallery_popup">
									<i class="icon-plus"></i>
								</a>
								<div id="gallery_${usergallist.gallery_id}" class="mfp-hide gallery_zoom">
									<img src="images/gallery/${usergallist.gallery_image}" class="img-responsive" alt="">
								</div>
							</div>
						</div>
                                        </div>
