		...
		<div class="row">
			...
			<div class="service_list_type">
				<div class="col-md-6 col-sm-12 pad_0">
					<div class="service_thumb">
                                            <img src="images/DIRECTION.jpg" class="img-responsive" alt="">
					</div>
				</div>
				<div class="col-md-6 col-sm-12">
					<div class="service_box">
						<div class="service_icon">
							<img src="images/icon_srvc2.png" class="img-responsive" alt="">
						</div>
						<h3>ನಿರ್ದೇಶನ</h3>
						
                                                <a href="admission.html"><button  class="w3-button"  style="background-color: #4f519e;color: #f5f5f5;width: 110px;height: 45px;" >ನಮ್ಮ ಜೊತೆಗೂಡು</button></a>
                                        </div>
				</div>
			</div>
			<!-- figure end -->
			...
			<div class="service_list_type">
				<div class="col-md-6 col-sm-12">
					<div class="service_box">
						<div class="service_icon">
							<img src="images/icon_srvc3.png" class="img-responsive" alt="">
						</div>
						<h3>ನಟನೆ</h3>
				...
				<div class="col-md-6 col-sm-12 pad_0">
					<div class="service_thumb">
						<img src="images/acting.jpg" class="img-responsive" alt="">
					</div>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="footer_content">
				...
				<p> &copy; 2018 Navarasa Natana Academy. All rights reserved | Design by <a target="_blank" href="#">Appfone</a></p>
			</div>
		</div>
	</div>
</div>
