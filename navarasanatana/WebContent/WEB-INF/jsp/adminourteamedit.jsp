            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                              <form:form method="post" action="saveadmineditteam.html" modelAttribute="adeditteam"  enctype="multipart/form-data">
                              <form:hidden path="team_id"/>
                              <input type="hidden" value="${teamimgtoedit}" name="teamimgtoedit">
                        <div class="col-md-3" >
