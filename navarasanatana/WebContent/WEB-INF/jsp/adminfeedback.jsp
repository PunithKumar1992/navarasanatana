    ...
    <div class="panel-heading">
     ...
     <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
        <c:forEach var="adminfeed" items="${adminfeedlist}">
        <c:url var="admindeletefeed" value="admindeletefeed.html">
        <c:param name="feed_id" value="${adminfeed.feed_id}"></c:param>
        </c:url>
        
	 <tr>
	 <td>${adminfeed.feed_name}</td>
	 <td>${adminfeed.feed_email}</td>
            <td>${adminfeed.feed_subject}</td>
			<td>${adminfeed.feed_msg}</td>
				<td>
	<a href="${admindeletefeed}"><i class="fa fa-trash" aria-hidden="true"></i></a>
