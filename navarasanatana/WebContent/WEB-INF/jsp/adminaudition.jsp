...
<section id="main-content">
            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form method="post" action="saveadminaudition.html" enctype="multipart/form-data" modelAttribute="adminaudition">
                                ...
                                <div class="col-md-3">
                                     ...
                                     <input type="file" id="fileUpload" onchange="Upload();" value="" accept=".jpg,.png,jpeg" name="auditionsfile">
                                </div>
                                <div class="col-md-3">
	...
	<section class="wrapper">
		...
		<!-- gallery -->
	<div class="gallery">
		<h2 class="w3ls_head">Audition Information</h2>
		<div class="gallery-grids">
			
				<c:forEach var="nnaaudition" items="${adminauditionlist}">
				<c:url var="deleteadminaudition" value="deleteadminaudition.html">
				<c:param name="audition_id" value="${nnaaudition.auditions_id}"></c:param>
				<c:param name="audition_image" value="${nnaaudition.auditions_image}"></c:param>
				</c:url>
					<div class="col-sm-4 gallery-grids">
					
					<a href="${deleteadminaudition}"><i class="fa fa-trash" aria-hidden="true"></i></a>
						<div class="gallery-grid" style="width:450px;height:300px;">
							<a class="example-image-link" href="images/auditions/${nnaaudition.auditions_image}" data-lightbox="example-set" >
								<img src="images/auditions/${nnaaudition.auditions_image}" alt="" style="width: 70%;height: 90%;" />
            ...
            reader.onload = function (e) {
                ...
                image.onload = function () {
                    ...
                    if (height <= 3000 && width <= 6000 ) {
                    	...
                    	{
                    	 alert("Height and Width must not exceed 3000px & 6000px.");
