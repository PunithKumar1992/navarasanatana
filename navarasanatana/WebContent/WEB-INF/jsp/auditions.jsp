	...
	<div class="container">
		<div class="row">
			...
			<div class="about_page_sec col-lg-12">
				...
				<c:forEach var="useraudlist" items="${useraudlist}">
				<div class="col-md-4">
                                    <a href="images/auditions/${useraudlist.auditions_image}"><img src="images/auditions/${useraudlist.auditions_image}" alt="" class="img-responsive"></a>
	...
	<div class="container">
		<div class="row">
			<div class="footer_content">
				...
				<p> &copy; 2017 Navarasa Natana Academy. All rights reserved | Design by <a target="_blank" href="#">Appfone</a></p>
			</div>
		</div>
	</div>
