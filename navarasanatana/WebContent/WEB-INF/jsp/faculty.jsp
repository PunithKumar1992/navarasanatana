	...
	<div class="container">
		<div class="row">
			...
			<div class="about_page_sec col-lg-12">
                              ...
                              <c:forEach var="userfacultylist" items="${userfacultylist}">  
                                <div class="col-md-3">
					<p class="teampad">
                                            <img src="images/faculty/${userfacultylist.faculty_image}">
						<span>${userfacultylist.faculty_name}  </span><br>
						<i>${userfacultylist.faculty_disc}</i>
					</p>
				</div>
                            </c:forEach>
	...
	<div class="container">
		<div class="row">
			<div class="footer_content">
				...
				<p> &copy; 2017 Navarasa Natana Academy. All rights reserved | Designed by <a target="_blank" href="#">Appfone</a></p>
			</div>
		</div>
	</div>
</div>
