...
<section id="main-content">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      Admisiion Information
    </div>
     <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            <th>Admisiion  Image</th>
			
            <th> Action</th>
          </tr>
        </thead>
        <tbody>
        <c:forEach var="admissionform" items="${adadmissionlist}">
    	<c:url var="admineditapplication" value="admineditapplication.html">
    	<c:param name="admission_id" value="${admissionform.admission_id}"></c:param>
    	<c:param name="admission_image" value="${admissionform.admission_image}"></c:param>
    	</c:url>
	 <tr>
            <td>
			<a class="example-image-link" href="images/admission/${admissionform.admission_image}" data-lightbox="example-set" >		
	<img src="images/admission/${admissionform.admission_image}" alt="" width="70%"/>
	</a>
			<!-- //gallery -->
			</td>
			<td>
		<a href="${admineditapplication}"> <i class="fa fa-pencil" aria-hidden="true"></i></a>
		  </td>
