            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form enctype="multipart/form-data" method="post" modelAttribute="adminads" action="saveadminads.html">
                                <div class="col-md-3">
                                <label>ಜಾಹೀರಾತು  ಚಿತ್ರ ಅಪ್ಲೋಡ್ ಮಾಡಿ
                                </label>
								</div>
                                <div class="col-md-3">
                                   
                                    <input type="file" id="fileUpload" onchange="Upload();" value="" accept=".jpg,.png,jpeg,gif" name="adsfile">
                                </div>
                                <div class="col-md-3">
                                    <button type="submit" id ="sub" class="btn btn-info" style="margin-top:-2%;" disabled>ಸೇರಿಸಿ</button>
                                </div>
                                </form:form>
                            </div>
                        </div>
    ...
    <div class="panel-heading">
     ...
     <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            <th>ಜಾಹೀರಾತು ಚಿತ್ರ</th>
			
            <th> ಕ್ರಿಯೆ</th>
          </tr>
        </thead>
        <tbody>
    <c:forEach var="adminads" items="${adminadslist}">
    <c:url var="addeleteads" value="addeleteads.html">
    <c:param name="ads_id" value="${adminads.ads_id}"></c:param>
    <c:param name="ads_image" value="${adminads.ads_id}"></c:param>
    </c:url>
     <tr>
            <td>
			<a class="example-image-link" href="images/ads/${adminads.ads_image}" data-lightbox="example-set" >		
	<img src="images/ads/${adminads.ads_image}" alt="" width="70%"/>
	</a>
	 <script src="adminjs/lightbox-plus-jquery.min.js"> </script>
			<!-- //gallery -->
			</td>
			<td>
		  <a href="${addeleteads}"><i class="fa fa-trash" aria-hidden="true" ></i></a>
		  </td>
